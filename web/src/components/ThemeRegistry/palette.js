...
const palette = {
  light: {
    ...
    mode: "light",
    text: { primary: GREY[900], secondary: GREY[800], disabled: GREY[600], light: GREY[300], lighter: GREY[100] },
    background: { paper: "#a14437", default: "#faebe8", neutral: "#1a0702", menu: "#e0b4a8" },
